                <div class="x_panel">
                  <div class="x_title">
                    <h2><?php echo  $header_tambahsupir; ?> </h2>
                    ...
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" enctype='multipart/form-data' method="post">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="nama_supir" name="nama_supir"  required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="number" onkeydown="return event.keyCode !== 69" id="no ktp" name="no_ktp" value="" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <?php if (isset($foto)){
                            echo '<input type="hidden" name="foto_lama" value="'.$foto.'">';
